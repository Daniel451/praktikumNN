...
\section{erkannte Probleme und unsere L"osungen}
...
\frame[t]
{
    \frametitle{rekurrentes Netz}
    
    \begin{beamercolorbox}[center]{}
        \includegraphics[]{recurentKNN.pdf}
    \end{beamercolorbox}%
