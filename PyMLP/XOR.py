...
nn = NeuralNetwork([2,100,1]) # Erstelle neues Neurales Netzwerk mit 2 Eingangsneuronen, 6 Hidden-Neuronen und 1 Ausgangsneuronen.
...
nn.teach(s_in, s_teach ,0.02,25000)  # Trainiren: 
